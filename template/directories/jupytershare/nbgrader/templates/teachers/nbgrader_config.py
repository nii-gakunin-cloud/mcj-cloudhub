...
from nbgrader.api import Student
...
# server set up.
c.CourseDirectory.course_id = "TemplateCourse"
...
## Set the log level by value or name.
#  See also: Application.log_level
c.GenerateConfigApp.log_level = 40
